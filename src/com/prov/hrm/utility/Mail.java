...
public class Mail {
	...
	public static boolean sendMailForCreateUser(String toEmail,String name,
			 String username, String password,int organizationId) {

		OrganizationDAOImpl org=new OrganizationDAOImpl();
		Organization organization= org.getOrganizationById(organizationId);
		...
		try {
			...
			message.addRecipient(Message.RecipientType.TO, new InternetAddress(
					toEmail));
			message.setSubject("Welcome to "+organization.getOrganizationName());
	...
	//send mail for creating Organization
		public static boolean sendMailForCreateOrganization(String name,
			...
			String body = "<p> Hi Admin,</p><p>Welcome to ProV HR Management Suite. Thank you for configuring "+ name + " Organisation in this application.</p><p>Your Login Name is "
				     + username + "</p><p>Your password is " + password + "</p>"+"<a href=\"http://192.168.1.38/HRMGITT/#/\">Click Here To Login</a><br/><br/><p>Thanks & Regards,</p><p>ProV International</p>";
