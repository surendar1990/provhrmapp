...
public class Employee{
	...
	public String toString() {
		return "{employeeId=" + employeeId + ", department=" + department
				...
				+ organizationId + ", roleId=" + roleId + ", empType="
				+ empType + ", empNo=" + empNo + ", dateOfJoining="
				+ dateOfJoining + ", firstName=" + firstName + ", middleName="
				+ middleName + ", lastName=" + lastName + ", contactNumber="
				+ contactNumber + ", emailId=" + emailId + ", panNumber="
				+ panNumber + ", passportNumber=" + passportNumber
